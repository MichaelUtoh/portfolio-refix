    ...
    return (
        <div className="flex flex-col items-center justify-center lg:w-full py-32">
            ...
            <div className="flex justify-between lg:w-8/12 mt-20">
                ...
                <div className="card flex flex-col font-one items-center hover:skew-x-[6deg] justify-center h-60 m-2 text-white w-64">
                ...
                <div className="card flex flex-col font-one items-center hover:-skew-x-[6deg] transform-gpu justify-center h-60 m-2 text-white w-64">
