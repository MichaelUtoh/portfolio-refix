...
const ContactComponent = () => {
    return (
        <>
            <div className="bg-green-500 flex items-center justify-center w-full mt-64 relative">
                ...
                <div className="absolute flex flex-col items-center justify-center my-20 w-10/12">
                    ...
                    <p className="absolute bottom-2 bottom-center font-two left-50 text-[#8a8a8a] text-xs">Michael Utoh &copy; 2022</p>
                </div>
