...
import { SiCss3, SiDjango, SiHtml5, SiJavascript, SiPython, SiReact, SiTailwindcss, SiChakraui } from 'react-icons/si'
    ...
    <>
        <div className="flex flex-col m-4">
            ...
            <div className="flex flex-wrap m-4 p-4 rounded-md w-full">
                ...
                <div className="card flex font items-center justify-center h-40 m-4 mt-10 relative text-white w-72">
                ...
                <div className="card flex font items-center justify-center h-40 m-4 mt-10 relative text-white w-72">
                    <SiHtml5 className="absolute left-[-20px] top-[-20px] text-blue-700 m-2 text-2xl" />
                    <SiCss3 className="absolute left-[10px] top-[-20px] text-red-400 m-2 text-2xl" />
                </div>
